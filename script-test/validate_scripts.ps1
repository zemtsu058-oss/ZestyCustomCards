...
function Test-LuaConstants {
    ...
    # 1. Standard EDOPro Constants List
    $validConstants = [System.Collections.Generic.HashSet[string]]::new([string[]]@(
        "ACTIVITY_ATTACK",
        ...
        "CHAININFO_TRIGGERING_STATUS",
        "CHAININFO_TRIGGERING_SUMMON_LOCATION",
        "CHAININFO_TRIGGERING_SUMMON_PROC_COMPLETE",
        "CHAININFO_TRIGGERING_SUMMON_TYPE",
        "CHAININFO_TRIGGERING_TYPE",
        "CHAININFO_TYPE",
        "CHINT_ATTRIBUTE",
        "CHINT_CARD",
        "CHINT_DESC_ADD",
        ...
        "EFFECT_ADD_LINKMARKER",
        "EFFECT_ADD_RACE",
        "EFFECT_ADD_SETCODE",
        "EFFECT_ADD_TYPE",
        "EFFECT_ALLOW_NEGATIVE",
        ...
        "EFFECT_CHANGE_LINK",
        "EFFECT_CHANGE_LINKMARKER",
        "EFFECT_CHANGE_LINK_FINAL",
        "EFFECT_CHANGE_LSCALE",
        "EFFECT_CHANGE_RACE",
        "EFFECT_CHANGE_RANK",
        "EFFECT_CHANGE_RANK_FINAL",
        "EFFECT_CHANGE_RSCALE",
        "EFFECT_CHANGE_SETCODE",
        "EFFECT_CHANGE_TYPE",
        "EFFECT_CLEAR_WALL",
        "EFFECT_CLEAR_WORLD_IMMUNE",
        "EFFECT_COST_REPLACE",
        ...
        "EFFECT_CYBERDARK_WORLD",
        "EFFECT_DARKNESS_HIDE",
        ...
        "EFFECT_FLAG2_COF",
        "EFFECT_FLAG2_CONTINUOUS_EQUIP",
        "EFFECT_FLAG2_FORCE_ACTIVATE_LOCATION",
        "EFFECT_FLAG2_MAJESTIC_MUST_COPY",
        ...
        "EFFECT_FORCE_SPSUMMON_POSITION",
        "EFFECT_FORMUD_SKIPPER",
        "EFFECT_FUR_HIRE_REPLACE",
        "EFFECT_FUSION_MATERIAL",
        "EFFECT_FUSION_MAT_RESTRICTION",
        "EFFECT_FUSION_SUBSTITUTE",
        "EFFECT_GEMINI_STATUS",
        "EFFECT_GEMINI_SUMMONABLE",
        "EFFECT_GOLDEN_ALLURE_QUEEN",
        "EFFECT_HAND_LIMIT",
        "EFFECT_HAND_SYNCHRO",
        "EFFECT_ICEBARRIER_REPLACE",
        ...
        "EFFECT_LEVEL_RANK",
        "EFFECT_LEVEL_RANK_S",
        "EFFECT_LIGHT_OF_INTERVENTION",
        "EFFECT_LIMIT_SET_PROC",
        "EFFECT_LIMIT_SUMMON_PROC",
        "EFFECT_LPCOST_CHANGE",
        "EFFECT_LPCOST_REPLACE",
        "EFFECT_MARKER_ALLURE_LVUP",
        "EFFECT_MARKER_CARDIAN",
        "EFFECT_MARKER_DETACH_XMAT",
        "EFFECT_MARKER_DRAGON_RULER",
        "EFFECT_MARKER_TELLAR",
        "EFFECT_MARKER_THUNDRA",
        "EFFECT_MATCH_KILL",
        ...
        "EFFECT_SSET_COST",
        "EFFECT_STAR_SERAPH_SOVEREIGNTY",
        "EFFECT_SUMMON_COST",
        "EFFECT_SUMMON_PROC",
        "EFFECT_SUPREME_CASTLE",
        "EFFECT_SWAP_AD",
        ...
        "EFFECT_SYNCHRO_MAT_FROM_HAND",
        "EFFECT_SYNCHRO_MAT_RESTRICTION",
        "EFFECT_SYNSUB_NORDIC",
        ...
        "EFFECT_WITCHCRAFTER_REPLACE",
        "EFFECT_XYZ_LEVEL",
        "EFFECT_XYZ_MATERIAL",
        "EFFECT_XYZ_MAT_FROM_GRAVE",
        "EFFECT_XYZ_MAT_RESTRICTION",
        "EVENT_ADD_COUNTER",
        "EVENT_ADJUST",
        ...
        "LOCATION_REASON_COUNT",
        "LOCATION_REASON_RETURN",
        ...
        "REASON_TEMPORARY",
        "REASON_XYZ",
        "REGISTER_FLAG_ALLURE_LVUP",
        "REGISTER_FLAG_CARDIAN",
        "REGISTER_FLAG_DETACH_XMAT",
        "REGISTER_FLAG_DRAGON_RULER",
        "REGISTER_FLAG_TELLAR",
        "REGISTER_FLAG_THUNDRA",
        "RESETS_CANNOT_ACT",
        "RESETS_REDIRECT",
        "RESETS_STANDARD",
        ...
        "WIN_REASON_CREATOR_MIRACLE",
        "WIN_REASON_DECK_MASTER",
        "WIN_REASON_DESTINY_BOARD",
        "WIN_REASON_DEUCE",
        "WIN_REASON_DISASTER_LEO",
        "WIN_REASON_DRAW_OF_FATE",
        "WIN_REASON_EVIL_1",
        "WIN_REASON_EXODIA",
        "WIN_REASON_EXODIA_DEFENDER",
        "WIN_REASON_EXODIUS",
        "WIN_REASON_FA_WINNERS",
        "WIN_REASON_FINAL_COUNTDOWN",
        "WIN_REASON_FINAL_DRAW",
        "WIN_REASON_FLYING_ELEPHANT",
        "WIN_REASON_GHOSTRICK_MISCHIEF",
        "WIN_REASON_JACKPOT7",
        "WIN_REASON_LAST_TURN",
        "WIN_REASON_MATCH_WINNER",
        "WIN_REASON_MUSICAL_SUMO",
        "WIN_REASON_PHANTASM_SPIRAL",
        "WIN_REASON_PUPPET_LEO",
        "WIN_REASON_RELAY_SOUL",
        "WIN_REASON_SUMMER_SCHOOLWORK",
        "WIN_REASON_TRUE_EXODIA",
        "WIN_REASON_VENNOMINAGA",
        "WIN_REASON_ZERO_GATE",
        "ZONES_EMZ",
        "ZONES_MMZ",
        "ZONE_CENTER_MMZ"
    ))
    ...
    $customPath = "script/constants.lua"
    if (Test-Path $customPath) {
        ...
        foreach ($m in $customMatches) {
            [void]$validConstants.Add($m.Value)
        }
    }
    ...
    foreach ($m in $matches) {
        ...
        if ($hasPrefix -and -not $validConstants.Contains($val)) {
